...
var Sidebar = function (_Component) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !((0, _generic.arraysEqual)(nextProps.groups, this.props.groups) && nextProps.keys === this.props.keys && nextProps.width === this.props.width && nextProps.groupHeights === this.props.groupHeights && nextProps.height === this.props.height && nextProps.hoveredGroupId === this.props.hoveredGroupId);
    }
  }, {
    key: 'renderGroupContent',
    value: function renderGroupContent(group, isRightSidebar, groupTitleKey, groupRightTitleKey, groupIndex) {
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          hoveredGroupId = _props.hoveredGroupId,
          onRowEnter = _props.onRowEnter;
      ...
      this.props.groups.forEach(function (group, index) {
        ...
        groupLines.push(_react2.default.createElement(
          'div',
          {
            ...
            className: 'rct-sidebar-row' + (i % 2 === 0 ? ' rct-sidebar-row-even' : ' rct-sidebar-row-odd') + (i === hoveredGroupId ? ' hovered' : ''),
            style: elementStyle,
            onMouseEnter: function onMouseEnter(evt) {
              return onRowEnter(evt, copyI);
            }
          },
          _this2.renderGroupContent(group, isRightSidebar, groupTitleKey, groupRightTitleKey, i)
        ));
        i += 1;
      });
