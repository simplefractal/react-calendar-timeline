...
var GroupRows = function (_Component) {
  ...
  _createClass(GroupRows, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !(nextProps.canvasWidth === this.props.canvasWidth && nextProps.lineCount === this.props.lineCount && nextProps.groupHeights === this.props.groupHeights && nextProps.hoveredGroupId === this.props.hoveredGroupId);
    }
  }, {
    key: 'render',
