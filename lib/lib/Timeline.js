...
function nostack(items, groupOrders, lineHeight, force, activitiesArray, ignoreActivitiesHeight) {
  var i, iMax;
  var totalHeight = 0;
  ...
  groupedItems.forEach(function (group, index) {
    ...
    var activitiesHeight = ignoreActivitiesHeight ? 0 : activitiesArray ? activitiesArray[index] * 30 : 0;
...
var ReactCalendarTimeline = function (_Component) {
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function infoLabel() {
      var infoLabel = this.props.infoLabel;
    ...
    value: function stackItems(items, groups, canvasTimeStart, visibleTimeStart, visibleTimeEnd, width) {
      ...
      var _props2 = this.props,
          ...
          ignoreActivitiesHeight = _props2.ignoreActivitiesHeight;
      ...
      var stackingMethod = stackItems ? _calendar.stack : nostack;

      var groupActivitiesArray = void 0;
      if (!stackItems) {
        groupActivitiesArray = groups.map(function (group) {
          return group.activityRows ? Object.keys(group.activityRows).length : 0;
        });
      }

      var _stackingMethod = stackingMethod(dimensionItems, groupOrders, lineHeight, headerHeight, groupActivitiesArray, ignoreActivitiesHeight),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getTimeFromRowClickEvent = function (e) {
    ...
    return Math.round(visibleTimeStart + x / width * (visibleTimeEnd - visibleTimeStart));
  };
  ...
  this.handleRowEnter = function (e, rowIndex) {
    _this4.setState({ hoveredGroup: rowIndex });
  };

  this.handleMouseLeave = function (e) {
    _this4.setState({ hoveredGroup: null });
  };
